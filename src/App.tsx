...
function App() {
  ...
  return (
    <>
      <div className="bg-white flex justify-center items-center p-5 sm:p-2">
        <h1 className="text-sm font-serif text-black font-bold sm:text-lg md:text-xl">
          Discover the weather in every city you go by just clicking or right
          clicking on the city name
        </h1>
        <img className="w-12 h-12 mx-4 sm:w-8 sm:h-8" src={season} />
      </div>
      <div
        className="App flex justify-center min-h-screen bg-cover bg-center"
        style={{ backgroundImage: `url(${img1})` }}
      >
        <div className="overflow-x-auto w-auto text-xs px-2 sm:px-2 sm:w-full sm:text-base md:px-2 md:w-full ">
          <table className="w-full mt-10 table-auto text-sm md:text-base">
